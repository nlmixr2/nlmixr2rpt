...
Browse through the [documentation](https://nlmixr2rpt.nlmixr2.org/) and check out the vignette: 

* [Reporting `nlmixr` Fit Results](https://nlmixr2rpt.nlmixr2.org/articles/Reportin_nlmixr_Fit_Results.html)
* [Accessing Figures and Tables](https://nmlixr2rpt.nlmixr2.org/articles/Accessing_Figures_and_Tables.html)
